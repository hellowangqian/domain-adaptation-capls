...
clear all %#ok<CLALL>
addpath('./utils/');
data_dir = '/mnt/HD2T/DomainAdaptation/image-clef/';
...
save(['imageclef-SP-' num2str(using_sp) '-PcaDim-' num2str(opts.ReducedDim) '-LppDim-' num2str(d) '-T-' num2str(T) '.mat'],'all_acc_per_class','all_acc_per_image','mean_acc_per_class','mean_acc_per_image');
